...
const SignInPage = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center mt-20">
      ...
      <div className='sm:fixed sm:top-40'>
      <div className="text-center mb-8">
        <h1 className="text-5xl font-semibold mb-2 text-blue-600"><span className={`${caveat.className}`}>Welcome to the <span className='text-black'>Connect</span>O</span></h1>
