...
const RecordingLayout: React.FC = () => {
      ...
      <div className="flex-1 p-6 bg-gray-100 sm:ml-64">
        ...
        <div className="border border-gray-300 rounded-lg p-4 bg-white shadow-md">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-3xl font-semibold"> <span className={`${caveat.className}`}>Recording</span></h2>
            <button
          ...
          <div className="flex justify-center text-center text-gray-600 mb-4">
            All recorded meetings are listed below.
          </div>
